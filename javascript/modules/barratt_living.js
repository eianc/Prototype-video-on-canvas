...
export function livingEl(internalStage) {

	rectHeadline = createRect(rectHeadline, 'ce3017', -640, 260, 300, 40, 0.5);
	headline = createText(headline, 'More convenient living', 24, 'ffffff', -640, 265);
	...
	item1 = createText(item1, '○ Close to the A20 with easy access to Kent and beyond', 20, 'ffffff', -640, 327);
	item2 = createText(item2, '○ Harrietsham station within close proximity', 20, 'ffffff', -640, 327);
	item3 = createText(item3, '○ We have a fun, onsite play area planned', 20, 'ffffff', -640, 327);
